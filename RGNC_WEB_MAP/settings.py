"""
Django settings for RGNC_WEB_MAP project.
...
GDAL_LIBRARY_PATH = os.path.join(BASE_DIR,'GDAL_WINDOWS/gdal304')
...
SECRET_KEY = "django-insecure-qtc(t2u*pucf4d35+4to=9d0*_n+mtx8vd_4&@sv1obta*35fm"
...
ROOT_URLCONF = "RGNC_WEB_MAP.urls"
...
WSGI_APPLICATION = "RGNC_WEB_MAP.wsgi.application"
